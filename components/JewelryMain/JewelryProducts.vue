...
const products = ref([
  { name: 'Heart Song Pendant', color: 'Silver Pendant + Silver Chain', price: '€104', imageUrl: new URL('/public/images/Jewelry/Pendant_HeartSong_with_chain.webp', import.meta.url).href, hoverImageUrl: new URL('/public/images/Jewelry/Pendant_HeartSong.webp', import.meta.url).href },
  { name: 'Rising High Pendant', color: 'Silver Pendant + Silver Chain', price: '€104', imageUrl: new URL('/public/images/Jewelry/Pendant_RisingHigh_with_chain.webp', import.meta.url).href, hoverImageUrl: new URL('/public/images/Jewelry/Pendant_RisingHigh.webp', import.meta.url).href },
  { name: 'Urban Eagle Pendant', color: 'Silver Pendant + Silver Chain', price: '€104', imageUrl: new URL('/public/images/Jewelry/Pendant_UrbanEagle_with_chain.webp', import.meta.url).href, hoverImageUrl: new URL('/public/images/Jewelry/Pendant_UrbanEagle.webp', import.meta.url).href },
  { name: 'Vector Ville Pendant', color: 'Silver Pendant + Silver Chain', price: '€104', imageUrl: new URL('/public/images/Jewelry/Pendant_VectorVille_with_chain.webp', import.meta.url).href, hoverImageUrl: new URL('/public/images/Jewelry/Pendant_VectorVille.webp', import.meta.url).href },
]);
